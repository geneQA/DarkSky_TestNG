 ...
 public void scrollDownPage(WebDriver driver, int y) {
 	JavascriptExecutor js = ((JavascriptExecutor) driver);
 ...
 public static void sendKeysUsingJSWithID(WebDriver driver, String string, String value){
 	JavascriptExecutor js = ((JavascriptExecutor) driver);
 	js.executeScript("document.getElementById('" + string + "').value='"+value+"'");
 }
